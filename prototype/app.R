...
ui <- navbarPage(
  ...
  tabPanel("Introduction", 
           ...
           mainPanel(
             ...
             HTML("<p></p>"),
             HTML("<h4>Lastly, we realise that the app might sometimes fail to load."),
             HTML("Please visit <a href='https://github.com/kimsiang1994/ISS608_shiny_app'>here</a> for a peep into our source code.</h4>"), 
             HTML("<p></p>"),
  ...
  navbarMenu("Employee",
             tabPanel("Income and Expense",
                      ...
                      sidebarPanel(
                        ...
                        HTML("<p>Please note that violin plots are not accurate when too many are shown concurrently. Please switch off some labels to have a better picture of the distribution of your desired factor.</p>"),
